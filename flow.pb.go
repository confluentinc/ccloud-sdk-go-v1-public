...
type GetLoginRealmReply struct {
	...
	MfaEnabled           bool     `protobuf:"varint,4,opt,name=mfa_enabled,json=mfaEnabled,proto3" json:"mfa_enabled,omitempty" db:"mfa_enabled,omitempty" url:"mfa_enabled,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *GetLoginRealmReply) GetMfaEnabled() bool {
	if m != nil {
		return m.MfaEnabled
	}
	return false
...
var fileDescriptor_3c1fa740027c1208 = []byte{
	...
	,
}
