...
type RBACRoleBindingCRUDApi struct {
	...
	AddRoleForPrincipalFunc func(ctx context.Context, principal, roleName string, scope github_com_confluentinc_ccloud_sdk_go_v1_public_mdsv2alpha1.Scope) (*net_http.Response, error)

	lockAddRoleResourcesForPrincipal sync.Mutex
	AddRoleResourcesForPrincipalFunc func(ctx context.Context, principal, roleName string, resourcesRequest github_com_confluentinc_ccloud_sdk_go_v1_public_mdsv2alpha1.ResourcesRequest) (*net_http.Response, error)

	lockDeleteRoleForPrincipal sync.Mutex
	DeleteRoleForPrincipalFunc func(ctx context.Context, principal, roleName string, scope github_com_confluentinc_ccloud_sdk_go_v1_public_mdsv2alpha1.Scope) (*net_http.Response, error)

	lockRemoveRoleResourcesForPrincipal sync.Mutex
	RemoveRoleResourcesForPrincipalFunc func(ctx context.Context, principal, roleName string, resourcesRequest github_com_confluentinc_ccloud_sdk_go_v1_public_mdsv2alpha1.ResourcesRequest) (*net_http.Response, error)
	...
	calls struct {
		...
		AddRoleResourcesForPrincipal []struct {
			...
			Principal        string
			RoleName         string
			ResourcesRequest github_com_confluentinc_ccloud_sdk_go_v1_public_mdsv2alpha1.ResourcesRequest
		}
...
func (m *RBACRoleBindingCRUDApi) AddRoleForPrincipal(ctx context.Context, principal, roleName string, scope github_com_confluentinc_ccloud_sdk_go_v1_public_mdsv2alpha1.Scope) (*net_http.Response, error) {
...
func (m *RBACRoleBindingCRUDApi) AddRoleResourcesForPrincipal(ctx context.Context, principal, roleName string, resourcesRequest github_com_confluentinc_ccloud_sdk_go_v1_public_mdsv2alpha1.ResourcesRequest) (*net_http.Response, error) {
...
func (m *RBACRoleBindingCRUDApi) DeleteRoleForPrincipal(ctx context.Context, principal, roleName string, scope github_com_confluentinc_ccloud_sdk_go_v1_public_mdsv2alpha1.Scope) (*net_http.Response, error) {
...
func (m *RBACRoleBindingCRUDApi) RemoveRoleResourcesForPrincipal(ctx context.Context, principal, roleName string, resourcesRequest github_com_confluentinc_ccloud_sdk_go_v1_public_mdsv2alpha1.ResourcesRequest) (*net_http.Response, error) {
