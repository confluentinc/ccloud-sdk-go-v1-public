...
type RBACRoleDefinitionsApi struct {
	...
	RoleDetailFunc func(ctx context.Context, roleName string, localVarOptionals *github_com_confluentinc_ccloud_sdk_go_v1_public_mdsv2alpha1.RoleDetailOpts) (github_com_confluentinc_ccloud_sdk_go_v1_public_mdsv2alpha1.Role, *net_http.Response, error)

	lockRolenames sync.Mutex
	RolenamesFunc func(ctx context.Context, localVarOptionals *github_com_confluentinc_ccloud_sdk_go_v1_public_mdsv2alpha1.RolenamesOpts) ([]string, *net_http.Response, error)

	lockRoles sync.Mutex
	RolesFunc func(ctx context.Context, localVarOptionals *github_com_confluentinc_ccloud_sdk_go_v1_public_mdsv2alpha1.RolesOpts) ([]github_com_confluentinc_ccloud_sdk_go_v1_public_mdsv2alpha1.Role, *net_http.Response, error)

	calls struct {
		RoleDetail []struct {
			Ctx               context.Context
			RoleName          string
			LocalVarOptionals *github_com_confluentinc_ccloud_sdk_go_v1_public_mdsv2alpha1.RoleDetailOpts
		}
		Rolenames []struct {
			Ctx               context.Context
			LocalVarOptionals *github_com_confluentinc_ccloud_sdk_go_v1_public_mdsv2alpha1.RolenamesOpts
		}
		Roles []struct {
			Ctx               context.Context
			LocalVarOptionals *github_com_confluentinc_ccloud_sdk_go_v1_public_mdsv2alpha1.RolesOpts
		}
	}
}

// RoleDetail mocks base method by wrapping the associated func.
func (m *RBACRoleDefinitionsApi) RoleDetail(ctx context.Context, roleName string, localVarOptionals *github_com_confluentinc_ccloud_sdk_go_v1_public_mdsv2alpha1.RoleDetailOpts) (github_com_confluentinc_ccloud_sdk_go_v1_public_mdsv2alpha1.Role, *net_http.Response, error) {
...
func (m *RBACRoleDefinitionsApi) Rolenames(ctx context.Context, localVarOptionals *github_com_confluentinc_ccloud_sdk_go_v1_public_mdsv2alpha1.RolenamesOpts) ([]string, *net_http.Response, error) {
...
func (m *RBACRoleDefinitionsApi) Roles(ctx context.Context, localVarOptionals *github_com_confluentinc_ccloud_sdk_go_v1_public_mdsv2alpha1.RolesOpts) ([]github_com_confluentinc_ccloud_sdk_go_v1_public_mdsv2alpha1.Role, *net_http.Response, error) {
	m.lockRoles.Lock()
